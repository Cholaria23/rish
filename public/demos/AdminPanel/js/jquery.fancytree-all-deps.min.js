    ...
    ! function(a, b, c, d) {
        ...
        e(a.ui, "Fancytree requires jQuery UI (http://jqueryui.com)"), s.prototype = {
            ...
            _changeSelectStatusAttrs: function(a) {
                var b = !1,
                    c = this.tree.options,
                    f = w.evalOption("unselectable", this, this, c, !1),
            ...
            nodeSetFocus: function(b, d) {
                ...
                d && (this.hasFocus() || (g.debug("nodeSetFocus: forcing container focus"), this._callHook("treeSetFocus", b, !0, {
                    ...
                    scrollIntoView: !1
                }), f.focusNode = g, h.titlesTabbable ? i || a(g.span).find(".fancytree-title").focus() : 0 === a(c.activeElement).closest(".fancytree-container").length && a(f.$container).focus(), h.aria && a(f.$container).attr("aria-activedescendant", a(g.tr || g.li).uniqueId().attr("id")), this._triggerNodeEvent("focus", b), h.autoScroll && g.scrollIntoView(), this._callHook("nodeRenderStatus", b))
            },
            nodeSetSelected: function(a, b, c) {
                ...
                if (b = b !== !1, !w.evalOption("unselectable", d, d, f, !1)) {
                    ...
                    b && 1 === f.selectMode ? (e.lastSelectedNode && e.lastSelectedNode.setSelected(!1), d.selected = b) : 3 !== f.selectMode || !h || h.radiogroup || d.radiogroup ? h && h.radiogroup ? d.visitSiblings(function(a) {
            ...
            treeSetFocus: function(b, c, d) {
                var e;
                c = c !== !1, c !== this.hasFocus() && (this._hasFocus = c, !c && this.focusNode ? this.focusNode.setFocus(!1) : !c || d && d.calledByNode || a(this.$container).focus(), this.$container.toggleClass("fancytree-treefocus", c), this._triggerTreeEvent(c ? "focusTree" : "blurTree"), c && !this.activeNode && (e = this._lastMousedownNode || this.getFirstChild(), e && e.setFocus()))
            },
            ...
            _bind: function() {
                ...
                }).on("mousedown" + d, function(b) {
                    var c = w.getEventTarget(b);
                    a.tree._lastMousedownNode = c ? c.node : null
        ...
        a.ui.fancytree.registerExtension({
            ...
            treeInit: function(b) {
                var c, e = b.tree,
                    ...
                    l = g.glyph || null,
                    m = g.dnd5,
                    p = a.ui.fancytree.getNode;
                a.inArray("dnd", g.extensions) >= 0 && a.error("Extensions 'dnd' and 'dnd5' are mutually exclusive."), m.dragStop && a.error("dragStop is not used by ext-dnd5. Use dragEnd instead."), m.dragStart && a.ui.fancytree.overrideMethod(b.options, "createNode", function(a, b) {
                    this._super.apply(this, arguments), b.node.span.draggable = !0
                }), this._superApply(arguments), this.$container.addClass("fancytree-ext-dnd5"), c = a("<span>").appendTo(this.$container), this.$scrollParent = c.scrollParent(), c.remove(), r = a("#fancytree-drop-marker"), r.length || (r = a("<div id='fancytree-drop-marker'></div>").hide().css({
                    "z-index": 1e3,
                    "pointer-events": "none"
                }).prependTo("body"), l && r.addClass(l.map.dropMarker)), m.dragStart && e.$container.on("dragstart drag dragend", function(b) {
                    var c, f = p(b),
                        g = b.dataTransfer || b.originalEvent.dataTransfer,
                        h = "move" === g.dropEffect,
                        k = f ? a(f.span) : null,
                        l = {
                            node: f,
                    ...
                    switch (b.type) {
                        case "dragstart":
                            a(f.span).addClass(i), s = f, c = JSON.stringify(f.toDict());
                            try {
                                g.setData(q, c), g.setData("text/html", a(f.span).html()), g.setData("text/plain", f.title)
                            } catch (n) {
                                e.warn("Could not set data (IE only accepts 'text') - " + n)
                            }
                            return m.setTextTypeJson ? g.setData("text", c) : g.setData("text", f.title), g.effectAllowed = "all", g.setDragImage && g.setDragImage(a(f.span).find(".fancytree-title")[0], -10, -10), m.dragStart(f, l) !== !1;
                        case "drag":
                            k.toggleClass(j, h), m.dragDrag(f, l);
                            break;
                        case "dragend":
                            a(f.span).removeClass(i + " " + j), s = null, t = null, l.isCancelled = "none" === g.dropEffect, r.hide(), m.dragEnd(f, l)
                    }
                }), m.dragEnter && e.$container.on("dragenter dragover dragleave drop", function(b) {
                    var c, g, i, j, l = null,
                        v = p(b),
                    ...
                    switch (b.type) {
                        case "dragenter":
                            if (!v) {
                                e.debug("Ignore non-node " + b.type + ": " + b.target.tagName + "." + b.target.className), t = !1;
                                break
                            }
                            if (a(v.span).addClass(n).removeClass(k + " " + o), m.preventNonNodes && !g) {
                                v.debug("Reject dropping a non-node"), t = !1;
                                break
                            }
                            if (m.preventForeignNodes && (!s || s.tree !== v.tree)) {
                                v.debug("Reject dropping a foreign node"), t = !1;
                                break
                            }
                            setTimeout(function() {
                                !m.autoExpandMS || v.hasChildren() === !1 || v.expanded || m.dragExpand && m.dragExpand(v, x) === !1 || v.scheduleAction("expand", m.autoExpandMS)
                            }, 0), r.show(), m.preventRecursiveMoves && v.isDescendantOf(x.otherNode) ? j = !1 : (i = m.dragEnter(v, x), j = f(i)), t = j, l = j && (j.over || j.before || j.after);
                            break;
                        case "dragover":
                            u = h(b, x), l = !!u;
                            break;
                        case "dragleave":
                            if (!v) {
                                e.debug("Ignore non-node " + b.type + ": " + b.target.tagName + "." + b.target.className);
                                break
                            }
                            ...
                            a(v.span).removeClass(n + " " + k + " " + o), v.scheduleAction("cancel"), m.dragLeave(v, x), r.hide();
                            break;
                        case "drop":
                            if (a.inArray(q, w.types) >= 0 && (g = w.getData(q), e.info(b.type + ": getData('application/x-fancytree-node'): '" + g + "'")), g || (g = w.getData("text"), e.info(b.type + ": getData('text'): '" + g + "'")), g) try {
                                c = JSON.parse(g), c.title !== d && (x.otherNodeData = c)
                            } catch (y) {}
                            e.debug(b.type + ": nodeData: '" + g + "', otherNodeData: ", x.otherNodeData), a(v.span).removeClass(n + " " + k + " " + o), r.hide(), x.hitMode = u, x.dropEffect = w.dropEffect, x.isCancelled = "none" === x.dropEffect, m.dragDrop(v, x), b.preventDefault()
                    }
                    if (l) return b.preventDefault(), !1
                })
            }
        })
    }(jQuery, window, document);
    ...
    ! function(a, b, c, d) {
        ...
        a.ui.fancytree._FancytreeClass.prototype._applyFilterImpl = function(b, c, d) {
            var i, j, k, l, m, n = 0,
                ...
                p = o.escapeTitles,
                q = o.autoCollapse,
                r = a.extend({}, o.filter, d),
                s = "hide" === r.mode,
                t = !!r.leavesOnly && !c;
            if ("string" == typeof b) {
                if ("" === b) return this.warn("Fancytree passing an empty string as a filter is handled as clearFilter()."), void this.clearFilter();
                i = r.fuzzy ? b.split("").reduce(function(a, b) {
                    return a + "[^" + b + "]*" + b
                }) : e(b), k = new RegExp(".*" + i + ".*", "i"), l = new RegExp(e(b), "gi"), b = function(a) {
                    var b = p ? a.title : f(a.title),
                        c = !!k.test(b);
                    return c && r.highlight && (p ? (m = b.replace(l, function(a) {
                        return "￷" + a + "￸"
                    }), a.titleWithHighlight = h(m).replace(/\uFFF7/g, "<mark>").replace(/\uFFF8/g, "</mark>")) : a.titleWithHighlight = b.replace(l, function(a) {
                        return "<mark>" + a + "</mark>"
                    })), c
                }
            }
            return this.enableFilter = !0, this.lastFilterArgs = arguments, this.$div.addClass("fancytree-ext-filter"), s ? this.$div.addClass("fancytree-ext-filter-hide") : this.$div.addClass("fancytree-ext-filter-dimm"), this.$div.toggleClass("fancytree-ext-filter-hide-expanders", !!r.hideExpanders), this.visit(function(a) {
                delete a.match, delete a.titleWithHighlight, a.subMatchCount = 0
            }), j = this.getRootNode()._findDirectChild(g), j && j.remove(), o.autoCollapse = !1, this.visit(function(a) {
                if (!t || null == a.children) {
                    var d = b(a),
                        e = !1;
                    if ("skip" === d) return a.visit(function(a) {
                        a.match = !1
                    }, !0), "skip";
                    d || !c && "branch" !== d || !a.parent.match || (d = !0, e = !0), d && (n++, a.match = !0, a.visitParents(function(a) {
                        a.subMatchCount += 1, !r.autoExpand || e || a.expanded || (a.setExpanded(!0, {
                            noAnimation: !0,
                            noEvents: !0,
                            scrollIntoView: !1
            ...
            }), o.autoCollapse = q, 0 === n && r.nodata && s && (j = r.nodata, a.isFunction(j) && (j = j()), j === !0 ? j = {} : "string" == typeof j && (j = {
                title: j
            }), j = a.extend({
                statusNodeType: "nodata",
                key: g,
                title: this.options.strings.noData
            }, j), this.getRootNode().addNode(j).match = !0), this.render(), n
    ...
    ! function(a, b, c, d) {
        ...
        a.ui.fancytree.registerExtension({
            ...
            treeInit: function(b) {
                var c = b.tree,
                    d = b.options.glyph;
                d.preset ? (f.assert(!!g[d.preset], "Invalid value for `options.glyph.preset`: " + d.preset), d.map = a.extend({}, g[d.preset], d.map)) : c.warn("ext-glyph: missing `preset` option."), this._superApply(arguments), c.$container.addClass("fancytree-ext-glyph")
            },
            nodeRenderStatus: function(b) {
                var c, d, f, g = b.node,
                    h = a(g.span),
