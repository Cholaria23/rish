...
return [
    ...
    'btn' => [
        'sign_up' => 'Sign up',
        "feedback" => "To make an appointment",
        ...
        "order_translator" => "Order the “Personal Translator”",
        'send' => 'Send',
    ...
    'email' => [
        ...
        "question_services" => "Ask a services",
    ],
    'form' => [
        ...
        'for_service'  => 'To make an appointment',
    ...
    "chekup" => "Record on a Chek-Up",
    "sign_up_chekup" => "Sign up for a Chek-Up",
    ...
    "test_subtitle" => 'Result the next day',
