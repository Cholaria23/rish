@section('meta') 
    @if(isset($meta_type) && $meta_type == 'unit')
        ...
        <meta property="og:image" content="{{ (isset($unit) && $unit->img_1 != '') ? unit_img('thumb', $unit->img_1) : asset('storage/logo/logo_img_1.png') }}" />
        @php
    ...
    @elseif(isset($meta_type) && $meta_type == 'cat_unit')
        ...
        <meta property="og:image" content="{{ (isset($cat) && $cat->cover_1_img != '') ? cat_img('thumb', $cat->cover_1_img) : asset('storage/logo/logo_img_1.png') }}" />
        @php
    ...
    @elseif(isset($meta_type) && $meta_type == 'cat_good')
        ...
        <meta property="og:description" content="{{ htmlspecialchars($cat->lang->meta_desc) }}" />
        <meta property="og:image" content="{{ (isset($cat) && $cat->cover_1_img != '') ? market_cat_img('small', $cat->cover_1_img) : asset('storage/logo/logo_img_1.png') }}" />
        @php
    ...
    @elseif(isset($meta_type) && $meta_type == 'good')
        ...
        <meta property="og:image" content="{{ (isset($good) && $good->img_1 != '') ? good_img('small', $good->img_1) : asset('storage/logo/logo_img_1.png') }}" />
        @php
    ...
    @elseif(isset($meta_type) && $meta_type == 'brand')
        ...
        <meta property="og:image" content="{{ (isset($brand) && $brand->logo != '') ? market_brand_logo($brand->logo) : asset('storage/logo/logo_img_1.png') }}" />
        @php
