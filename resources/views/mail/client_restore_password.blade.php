...
<html lang="{{ app()->getLocale() }}" xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>@lang('main.request_call')</title>
        <style>
            p {
                margin: 0;
                padding: 0;
                                            ...
                                            <tr>
                                                <td align="left" valign="top" width="100%" border="0">
                                                    <div style="text-align: left; color:  #7b7b7b; font-weight: 400; font-size:18px; font-family: Arial,'Helvetica CY','Nimbus Sans L',sans-serif;">
                                                        <p style="margin: 0 0 10px; color:  #7b7b7b; font-weight:bold; font-size: 20px; text-align:center;">@lang('main.email.requested_rest') <a href="{{ URL::to('/') }}/" style="color: #244690; text-decoration:none; display:block;">{{env('APP_NAME', 'Laravel')}}</a></p>
                                                        <p style="font-size: 16px; margin: 0 0 5px;"><span style="color: #7b7b7b;">@lang('main.email.new_pass'):</span>  <span style="color: #2b2b2b">{{ $password }}</span></p>
                                                        <p style="font-size: 16px; margin: 0 0 5px; color: #7b7b7b;">@lang('main.email.change_pass') @lang('main.email.personal_office')</p>
